...
P=eye(15,15);
    ...
    Y=[];
    for i=1:30
         % sau khi bộ điều khiển hội tụ thì nhớ tắt cái nhiễu này đi
         % chứ không thì sẽ gặp tình trạng các biến trạng thái bị nhiễu
         % Tuy nhiên phải tắt đúng thời điểm, chứ không sẽ bị tình trạng
         % singularity liên tục như thầy Luỹ gặp phải
         explore=rand;
         xold=x;
         sim('hethong_RR1.mdl');
